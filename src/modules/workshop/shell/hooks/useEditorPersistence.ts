...
import {
  ...
  sanitizeEditorState,
  serializeEditorFile,
} from "../../bin/documents/state/editorFile";
import { defaultShellArrangements } from "../../bin/shell/utils/shellPanes";
import type { ContentDocument } from "../../documents";
import { EMPTY_EDITOR, type ProjectEditor, useWorkshopEditorStore } from "../state/workshopEditor";
