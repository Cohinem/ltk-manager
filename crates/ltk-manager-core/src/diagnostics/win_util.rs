...
use windows_sys::Win32::System::Registry::{
    HKEY, KEY_QUERY_VALUE, REG_VALUE_TYPE, RRF_RT_REG_DWORD, RRF_RT_REG_QWORD, RRF_RT_REG_SZ,
    RRF_ZEROONFAILURE, RegCloseKey, RegEnumValueW, RegGetValueW, RegOpenKeyExW,
};
