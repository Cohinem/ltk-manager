...
//!
//! ```text
//! cargo run --release -p dxbc-glsl --example sweep -- <wad> <out dir> <object path>...
//! ```
//!
...
use dxbc_glsl::bundle::{bundle_path, chunk_hash, index_in_bundle, read_toc, record, toc_path};
use dxbc_glsl::dxbc::reflect;
use dxbc_glsl::{Stage, translate};
use ltk_wad::Wad;
